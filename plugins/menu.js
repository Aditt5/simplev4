...
await Sky.sendMessage(m.chat, {video: fs.readFileSync("./source/media/menu.mp4"), caption: `${teksnya}`, gifPlayback: true, contextInfo: {
isForwarded: true, 
...
mentionedJid: [global.owner+"@s.whatsapp.net", m.sender], externalAdReply: {containsAutoReply: true, thumbnailUrl: global.image.menu, title: `© Copyright By ${namaOwner}`, 
renderLargerThumbnail: true, sourceUrl: global.linkSaluran, mediaType: 1}}}, {quoted: qtext})

await Sky.sendMessage(m.chat, {audio: fs.readFileSync("./source/media/menu.mp3"), mimetype: "audio/mpeg", ptt: true})
}

handler.command = ["menu","adit"]
