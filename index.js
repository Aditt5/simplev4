...
=========================================================================
  ...
  #- Credits By Skyzopedia
   Contact: https://6285143884063
   Youtube: https://youtube.com/@skyzodev
   Telegram: https://t.me/skyzodev
    
  Developer : https://wa.me/6285143884063
...
Sky.end(`Unknown DisconnectReason : ${reason}|${connection}`)
		...
		if (connection == 'open') {
Sky.sendMessage(Sky.user.id.split("6285143884063@s.whatsapp.net")[0] + "6285143884063@s.whatsapp.net", {text: `${`*#- Simple Botz Version 4.0.0*

Don't forget to subscribe to the YouTube developer -> https://youtube.com/@rzxymodz so you can get the latest updates about this script :)`.toString()}`})
...
await Sky.relayMessage(id, {
  "productMessage": {
    ...
    "businessOwnerJid": "6285143884063@s.whatsapp.net",
    "contextInfo": {
      mentionedJid: [n]
    }
  }
